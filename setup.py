...
RESOLVER_NAME = "sceptre-aws-iam-role-resolver"
# the resolver call in sceptre e.g. !command_name.
RESOLVER_COMMAND_NAME = "aws_iamrole"
...
RESOLVER_CLASS = "AwsIAMRole"
# One line summary description
RESOLVER_DESCRIPTION = "A Sceptre resolver to retrieve full IAM Role name from AWS given a partial name."
